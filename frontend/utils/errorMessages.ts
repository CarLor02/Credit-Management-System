...
export const AUTH_ERROR_MESSAGES: Record<string, string> = {
  ...
  // 新增详细错误信息
  '用户名错误，用户不存在': '用户名错误，用户不存在',
  '密码错误': '密码错误',
  '账户已被禁用，请联系管理员': '账户已被禁用，请联系管理员',
  '用户名已被注册，请选择其他用户名': '用户名已被注册，请选择其他用户名',
  '邮箱已被注册，请使用其他邮箱': '邮箱已被注册，请使用其他邮箱',
  '邮箱格式不正确': '邮箱格式不正确',
  '密码长度至少6位字符': '密码长度至少6位字符',
  '邮箱错误，与用户名不匹配': '邮箱错误，与用户名不匹配',
  '用户名不能为空': '用户名不能为空',
  '邮箱不能为空': '邮箱不能为空',
  '密码不能为空': '密码不能为空',
  '新密码不能为空': '新密码不能为空',
  '新密码长度至少6位字符': '新密码长度至少6位字符'
}; */
